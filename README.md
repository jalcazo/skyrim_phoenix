...
| 5 | [CBBE Body.](https://www.nexusmods.com/skyrimspecialedition/mods/198) | Nice body, UNP alternative gives nudes when looting females (not males), and it's quite un-immersive if you are doing an SFW playthrough. | [CBBE - Castellano - Spanish](https://www.nexusmods.com/skyrimspecialedition/mods/64240?tab=files) (updated 14 aug 2023). |
| 7 | CBBE AE-CC Outfits. (same page as CBBE Body) | Includes all Anniversary Edition/Creation Club outfits using the "CBBE Curvy (Outfit)" preset and BodySlide files. No body physics as almost all outfits part of it shouldn't have it anyway. Use BodySlide to apply other body presets yourself. | Not needed. |
